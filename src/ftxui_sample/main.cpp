...
// configuration step. It creates a namespace called `Ctemplate`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Ctemplate::cmake::project_name, Ctemplate::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", Ctemplate::cmake::project_version);
      return EXIT_SUCCESS;
    }
